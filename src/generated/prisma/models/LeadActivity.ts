...
export type LeadActivityWhereInput = {
  ...
  performedBy?: Prisma.StringFilter<"LeadActivity"> | string
...
export type LeadActivityScalarWhereWithAggregatesInput = {
  ...
  performedBy?: Prisma.StringWithAggregatesFilter<"LeadActivity"> | string
...
export type LeadActivityOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "leadId" | "type" | "description" | "metadata" | "performedBy" | "createdAt", ExtArgs["result"]["leadActivity"]>
...
export interface LeadActivityFieldRefs {
  ...
  readonly performedBy: Prisma.FieldRef<"LeadActivity", 'String'>
